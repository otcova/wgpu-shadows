    ...
    pub fn new(device: &wgpu::Device) -> Self {
        let instances: &[QuadInstance] = &[
            QuadInstance {
                ...
                size: [2., 2.],
                angle: 0.,
                tex_pos: TextureAtlas::view_triangles().pos,
                tex_size: TextureAtlas::view_triangles().size,
            },
            QuadInstance {
                pos: [0.0, 0.5],
                size: [1., 1.],
                angle: 0.,
                tex_pos: TextureAtlas::view_arrow().pos,
                tex_size: TextureAtlas::view_arrow().size,
            },
            QuadInstance {
                pos: [0.0, -0.5],
                size: [0.5, 0.5],
